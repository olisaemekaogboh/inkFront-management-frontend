...
export default function CookiesPolicyPage() {
  ...
  const updatedDate = t("cookies.updatedDate", "April 28, 2026");

  const sections = [
    {
      title: t("cookies.sections.whatAreCookies.title", "1. What Are Cookies?"),
      body: t(
        "cookies.sections.whatAreCookies.body",
    ...
    {
      title: t("cookies.sections.essential.title", "3. Essential Cookies"),
      body: t(
        "cookies.sections.essential.body",
    ...
    {
      title: t(
        "cookies.sections.authSecurity.title",
        "4. Authentication and Security Cookies",
      ),
      body: t(
    ...
    {
      title: t("cookies.sections.preference.title", "5. Preference Cookies"),
      body: t(
        "cookies.sections.preference.body",
        "Preference cookies help remember choices you make on the website, such as language, region, layout preference, dark mode, light mode, and cookie banner choices. These cookies improve user experience by preventing you from having to select the same options repeatedly.",
      ),
    },
    {
    ...
    {
      title: t(
        "cookies.sections.analytics.title",
    ...
    {
      title: t(
        "cookies.sections.clientProjects.title",
        "9. Cookies Used in Client Projects",
      ),
      body: t(
    ...
    {
      title: t("cookies.sections.managing.title", "10. Managing Cookies"),
      body: t(
        "cookies.sections.managing.body",
    ...
    {
      title: t(
        "cookies.sections.updates.title",
      ...
      <section className="premium-cta">
        <div className="premium-container premium-cta-inner">
          <span className="premium-eyebrow premium-eyebrow--light">
            {t("cookies.ctaEyebrow", "Your Choice")}
          </span>
          <h2>{t("cookies.ctaTitle", "You control your cookie settings")}</h2>
          <p>
            {t(
          ...
          <div className="premium-actions premium-actions-center">
            <Link to="/privacy" className="premium-btn premium-btn-light">
              {t("cookies.privacyButton", "Privacy Policy")}
            </Link>
